...
public class RecipeTypeManaPoolConjuration implements IRecipeType {

    public static final RecipeTypeManaPoolConjuration INSTANCE = new RecipeTypeManaPoolConjuration();
    public static final ResourceLocation NAME = new ResourceLocation("packaged_botania:mana_pool_conjuration");
    ...
    public String getLocalizedName() {
        return I18n.translateToLocal("recipe.packaged_botania.mana_pool_conjuration");
    }

    @Override
    public String getLocalizedNameShort() {
        return I18n.translateToLocal("recipe.packaged_botania.mana_pool_conjuration.short");
    }

    @Override
    public IRecipeInfo getNewRecipeInfo() {
        RecipeInfoManaPool info = new RecipeInfoManaPool();
        info.manaPoolRecipeType = RecipeInfoManaPool.TYPE_CONJURATION;
        return info;
    }
    ...
    public Object getRepresentation() {
        return new ItemStack(ModBlocks.conjurationCatalyst);
    }
