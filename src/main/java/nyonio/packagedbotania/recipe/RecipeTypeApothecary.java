...
public class RecipeTypeApothecary implements IRecipeType {

    public static final RecipeTypeApothecary INSTANCE = new RecipeTypeApothecary();
    public static final ResourceLocation NAME = new ResourceLocation("packaged_botania:apothecary");
    public static final IntSet SLOTS;
    public static final List<String> CATEGORIES = Arrays.asList("botania.petals");
    ...
    public String getLocalizedName() {
        return I18n.translateToLocal("recipe.packaged_botania.apothecary");
    }

    @Override
    public String getLocalizedNameShort() {
        return I18n.translateToLocal("recipe.packaged_botania.apothecary.short");
    }

    @Override
    public IRecipeInfo getNewRecipeInfo() {
        return new RecipeInfoApothecary();
    }
    ...
    public Int2ObjectMap<ItemStack> getRecipeTransferMap(IRecipeLayout recipeLayout, String category) {
        ...
        map.put(slotArray[0], PackagedBotaniaConfig.getApothecaryJEICatalyst());
        int index = 1;
        for(Map.Entry<Integer, ? extends IGuiIngredient<ItemStack>> entry : ingredients.entrySet()) {
            ...
            if(ingredient.isInput() && index < 17) {
                ...
                if(displayed != null && !displayed.isEmpty()) {
                    if(displayed.getItem() == net.minecraft.item.Item.getItemFromBlock(ModBlocks.altar)) {
                        continue;
                    }
