...
public class RecipeTypeManaPoolAlchemy implements IRecipeType {

    public static final RecipeTypeManaPoolAlchemy INSTANCE = new RecipeTypeManaPoolAlchemy();
    public static final ResourceLocation NAME = new ResourceLocation("packaged_botania:mana_pool_alchemy");
    ...
    public String getLocalizedName() {
        return I18n.translateToLocal("recipe.packaged_botania.mana_pool_alchemy");
    }

    @Override
    public String getLocalizedNameShort() {
        return I18n.translateToLocal("recipe.packaged_botania.mana_pool_alchemy.short");
    }

    @Override
    public IRecipeInfo getNewRecipeInfo() {
        RecipeInfoManaPool info = new RecipeInfoManaPool();
        info.manaPoolRecipeType = RecipeInfoManaPool.TYPE_ALCHEMY;
        return info;
    }
    ...
    public Object getRepresentation() {
        return new ItemStack(ModBlocks.alchemyCatalyst);
    }
