...
public class TileRuneAltarCrafter extends TileAE2Base implements ITickable, IPackageCraftingMachine, ISparkAttachable {
    ...
    protected IRecipeInfoRuneAltar currentRecipe;
    ...
    protected String getLocalizedName() {
        return I18n.translateToLocal("tile.packaged_botania.rune_altar_crafter.name");
    }
    ...
    public boolean acceptPackage(IRecipeInfo recipeInfo, List<ItemStack> stacks, EnumFacing facing) {
        if(!isBusy() && recipeInfo.isValid() && recipeInfo instanceof IRecipeInfoRuneAltar) {
            IRecipeInfoRuneAltar recipe = (IRecipeInfoRuneAltar)recipeInfo;
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        if(nbt.hasKey("Recipe")) {
            ...
            if(recipe instanceof IRecipeInfoRuneAltar) {
                currentRecipe = (IRecipeInfoRuneAltar)recipe;
            }
        }
