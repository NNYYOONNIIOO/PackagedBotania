...
import nyonio.packagedbotania.recipe.IRecipeInfoBrewery;
...
public class TileBreweryCrafter extends TileAE2Base implements ITickable, IPackageCraftingMachine, ISparkAttachable {

    public static int energyCapacity = 5000;
    public static int energyUsage = 100;

    // Inventory layout:
    // Slots 0-15: input (0=brew container, 1-6=ingredients, rest unused)
    // Slot 16: energy item slot
    // Slot 17: output slot
    protected int mana = 0;
    protected boolean isWorking = false;
    protected IRecipeInfoBrewery currentRecipe;
    ...
    protected String getLocalizedName() {
        return I18n.translateToLocal("tile.packaged_botania.brewery_crafter.name");
    }

    @Override
    protected ItemStack getStackRepresentation() {
        return new ItemStack(BlockBreweryCrafter.ITEM_INSTANCE);
    }
    ...
    protected void finishProcess() {
        ...
        world.playSound(null, pos, ModSounds.potionCreate, SoundCategory.BLOCKS, 1F, 1F);
        endProcess();
    }
    ...
    public boolean acceptPackage(IRecipeInfo recipeInfo, List<ItemStack> stacks, EnumFacing facing) {
        if(!isBusy() && recipeInfo.isValid() && recipeInfo instanceof IRecipeInfoBrewery) {
            IRecipeInfoBrewery recipe = (IRecipeInfoBrewery)recipeInfo;
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        if(nbt.hasKey("Recipe")) {
            ...
            if(recipe instanceof IRecipeInfoBrewery) {
                currentRecipe = (IRecipeInfoBrewery)recipe;
            }
        }
